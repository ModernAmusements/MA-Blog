---
title: Interactive timeline visualization of the Israel-Hamas conflict
...
# Israel-Hamas-Conflict.md: Israel-Hamas Conflict Timeline

## Project Overview

**Israel-Hamas-Conflict.md** is an interactive web application that visualizes the timeline of the Israel-Hamas conflict from 1900 to 2025. Built with vanilla JavaScript, Leaflet.js, and SCSS, this project provides an immersive way to explore historical events, military movements, and territorial changes through an interactive map interface.
