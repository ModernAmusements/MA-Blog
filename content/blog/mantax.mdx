---
title: "Building MANTAX: An Ethical Facial Recognition System for NGOs"
description: A technical deep-dive into MANTAX, an ethical facial recognition system designed for NGO use cases with local-only processing, dual-model embeddings, and confidence bands.
date: 2026-04-10
tags: ['python', 'computer-vision', 'flask', 'facial-recognition', 'onnx', 'electron']
...
![Face Detection Visualization](/images/projects/face_scanner/detection.jpg)
...
![Landmark Detection](/images/projects/face_scanner/mantax-landmarks.jpg)
...
![Neural Activations](/images/projects/face_scanner/activation.jpg)
